...
> 1. Ho, Jain, and Abbeel. "Denoising Diffusion Probabilistic Models."
> 2. Song, Meng, and Ermon. "Denoising Diffusion Implicit Models."
...
{% math() %}
\mathcal{L} = \mathbb{E} [ \underbrace{\| s_\theta(x_t, t, 0) - (x_1 - x_0)\|^2}_{\text{Flow-Matching}} + \underbrace{\|s_\theta(x_t, t, 2d) - \mathbf{s}_{\text{target}}\|^2}_{\text{Self-Consistency}}],
{% end %}
