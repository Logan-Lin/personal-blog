...
{% cap() %}My devices that use AA/AAA batteries or are simply battery-free.{% end %}
...
From my experience, such devices usually have a quite long battery life to begin with, so you don't need to constantly replace the batteries (_long live AA batteries, literally_).
